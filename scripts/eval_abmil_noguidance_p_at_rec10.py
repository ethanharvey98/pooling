"""Precision@10%Recall for the ABMIL (no guidance) row only, across
...
Run from the repo root in the neuroimg_gpu env:
    python scripts/eval_abmil_noguidance_p_at_rec10.py
"""
import os
import sys
...
def main():
    ...
    out_csv = "/cluster/home/zmou01/pooling/experiments/abmil_noguidance_p_at_rec10_3datasets.csv"
